...
<div bind:this={el} id="overlay-thing" class:ld={loading} class:open={visible} class="overlay-thing" class:reduced-motion={$global.settingsManager ? $global.settingsManager.settings.appearance.reduced_motion : false}>
