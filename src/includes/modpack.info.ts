...
export const ADDONS_INFO: { mods: { [key: string]: IAddonInfo }, dependencies: { [key: string]: IAddonInfo } } = {
    mods: {
        ...
        'jei': {
            ...
            link: 'https://github.com/Ektadelta/Addition/raw/main/mods/jei_1.12.2-4.16.1.302.jar',
    ...
    dependencies: {
        ...
        'jeiThaumic': {
            ...
            link: 'https://github.com/Ektadelta/Addition/raw/main/mods/ThaumicJEI-1.12.2-1.6.0-27.jar',
            dependencies: [ ],
            incompatable_modpacks: [ ],
        },
        'jeiBees': {
